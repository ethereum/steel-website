...
- [Consume](/docs/execution-specs/running_tests/consume/) - a family of [Hive](https://github.com/ethereum/hive) simulators that execute EEST vectors against clients by feeding blocks via RLP (upon startup) or the Engine API.
- [Execute](/docs/execution-specs/running_tests/execute/) - a framework for running EEST test vectors on live networks or as a Hive simulator, ensuring fixture compatibility across both simulated and real environments.

See the EEST docs [on running tests for an overview and comparison](/docs/execution-specs/running_tests/running/) of all Hive simulators and frameworks.
...
- [EELS Documentation](/docs/execution-specs/specs/reference/src/ethereum/index.html).
- [EEST Tooling Documentation](/docs/execution-specs/consensus_tests/).
- [EEST Test Case Documentation](/docs/execution-specs/tests/).
